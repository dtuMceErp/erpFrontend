...
function LandingPage() {
  return (
    <div className="body-wrap boxed-container" style={{ maxWidth: "100vw" }}>
      <Navbar />
          ...
          <div className="site-header-inner">
            <div className="brand header-brand">
              <img
                ...
                height={45}
                width="auto"
                alt="applied mathematics department"
              />
            </div>
          </div>
        </div> */}
          ...
          <div className="container">
            <div className="hero-inner">
              <div className="hero-copy">
                <h1 className="hero-title mt-0">ERPAM - DTU</h1>
                <p className="hero-paragraph">
                  A overall management system at Department of Applied
                  Mathematics, Delhi technological University, Delhi.
                </p>

                <Row>
                  <div
                    className="hero-form field field-grouped"
                    style={{ margin: "8px" }}
                  >
              ...
              <div className="hero-illustration">
                ...
                <div className="hero-main-shape d-none d-md-block">
                  <svg
                    width={940}
                    height={647}
                    viewBox="0 0 940 647"
          ...
          <div className="container">
            <div className="row py-4">
              <div className="col-sm-12 col-md-7">
                <h2 className="section-title mt-0">About Department</h2>
                <p className="text-secondary pr-md-5 text-justify">
                  The Department of Applied Mathematics is the pride of DTU. The
                  aim of the department is to impart the sound knowledge of
                  Mathematics, Statistics and Computing to the students through
                  teaching and research. The department is achieving its
                  goals/objectives with the help of highly qualified faculty.
                  The research output of the department is very impressive and
                  speaks clearly for the quality of work. Faculty members are
                  also actively involved in research, projects and various
                  academic activities.
                </p>
              </div>
              <div className="d-none d-md-block col-md-5 d-flex align-items-center w-100 pt-3">
                <img alt="departmentImg"
                  src="assets/dist/images/department.svg"
            ...
            <div className="features-inner section-inner">
              <div className="features-header text-center">
                <div className="container-sm">
                  <h2 className="section-title mt-0">Features Supported</h2>
              ...
              <div className="features-wrap">
                <div className="feature text-center is-revealing">
                  <div className="feature-inner">
                    ...
                    <h4 className="feature-title h3-mobile mb-8">Responsive</h4>
                    <p className="text-sm">
                      A pseudo-Latin text used in web design, layout, and
                      printing in place of English to emphasise design elements.
                    </p>
                  </div>
                </div>
                <div className="feature text-center is-revealing">
                ...
                <div className="feature text-center is-revealing">
                  <div className="feature-inner">
                    ...
                    <h4 className="feature-title h3-mobile mb-8">Scalable</h4>
                    <p className="text-sm">
                      A pseudo-Latin text used in web design, layout, and
                      printing in place of English to emphasise design elements.
                    </p>
                  ...
                  <div className="testimonial-inner">
                    <div className="testimonial-main">
                      <div className="testimonial-header">
                        <img
                          className="mb-16"
                          src="assets/dist/images/testimonial-01.png"
                          alt="Testimonial"
                        />
                      </div>
                  ...
                  <div className="testimonial-inner">
                    <div className="testimonial-main">
                      <div className="testimonial-header">
                        <img
                          className="mb-16"
                          src="assets/dist/images/testimonial-02.png"
                          alt="Testimonial"
                        />
                      </div>
                      <div className="testimonial-body">
                  ...
                  <div className="testimonial-inner">
                    <div className="testimonial-main">
                      <div className="testimonial-header">
                        <img
                          className="mb-16"
                          src="assets/dist/images/testimonial-03.png"
                          alt="Testimonial"
                        />
                      </div>
                      <div className="testimonial-body">
