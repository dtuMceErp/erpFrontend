...
function FaculityVerify(props) {
  ...
  const getData = () => {
    axios({
      method: "get",
      url: String(BASE_URL + "/user/faculty/verify/all"),
      headers: {
  ...
  function deleting(values) {
    ...
    axios({
      method: "delete",
      url: String(BASE_URL + `/user/faculty/verify/delete`),
      data: payload,
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
